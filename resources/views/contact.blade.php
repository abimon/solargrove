      ...
      <div class="col-md-6 p-5">
         ...
         <form action="" method='post' class="main_form">
            ...
            <div class="card p-2">
               ...
               <div class="mb-2">
                  <input class="form-control" placeholder="Phone Number" type="type" name="Phone Number">
               </div>
               <div class="mb-2">
                  <textarea class="form-control" placeholder="Message goes here..." type="type" Message="Name"></textarea>
               </div>
