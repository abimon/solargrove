            ...
            <div class="row mb-2">
                ...
                <div class="col-md-8 mb-2">
                    <div class="form-floating mb-2">
                        <input type="text" class="form-control" value="{{$article->title}}" name="title" placeholder=" " required>
                    ...
                    <textarea id="editor" name="content" rows="10">{{$article->content}}</textarea>
                    @error('content')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
